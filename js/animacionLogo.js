...
document.addEventListener('DOMContentLoaded', () => {
    ...
    logo.classList.add('animate--girar');
    logo__circulo.classList.add('animate--encoger');
    logo__Titulo.classList.add('animate--letras');
    logo__Eslogan.classList.add('animate--letras');
    header__contenerdor.classList.add('animate--contenedor');
